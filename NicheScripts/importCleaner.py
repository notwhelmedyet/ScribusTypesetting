...
#
#  importCleaner.py
#  sharable version with bugged sections removed
...
def main(args):
	...
	#if you don't want the script to try and replace breaks, set this to True
